...
$display_section = $section->display_section_one_student();
        ...
        <div class="column">
            ...
            <div class="section-column main-container">
                <div class="cols-title title-show">
                    <h4><i class="fa-solid fa-users fa-fw me-2"></i><?= ($_SESSION["role"] == "Administrator" || $_SESSION["role"] == "Teacher") ? "Section 1" : "My Class"; ?></h4>
                </div>
